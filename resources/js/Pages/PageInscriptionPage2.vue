...
const continuer = () => {
  axios.post('/utilisateur', {
    ...
    .then(response => {
      ...
      afficherMessageFunc("La demande d'inscription a été enregistrée avec succès", "Succès");
      routerV.push({
        path: '/'
    ...
    <div class="fr-grid-row fr-grid-row--center fr-mb-3w">
      <div class="fr-col-12 fr-col-md-6">
        ...
        <div class="fr-input-group fr-mt-2w">
          ...
          <input type="text" id="adressePostale" class="fr-input" v-model="adressePostale"
